...
static int unlink (const char *filename)
{
	...
	int copyNodeIDx = myFileSystem.directory.files[nodeIndexDir].nodeIdx; // Hacer una copia de nodoIDx del directorio que nos sirve para acceder al array de nodos.
